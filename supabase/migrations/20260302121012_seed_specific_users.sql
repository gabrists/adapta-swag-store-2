...
DECLARE
  ...
  users_to_insert JSON := '[
    {"name": "Paulo Zanquetta", "email": "paulo@adapta.org"},
    {"name": "Gabriel Henrique", "email": "gabriel.henrique@adapta.org"},
    {"name": "Felipe Batista", "email": "felipe.batista@adapta.org"},
    {"name": "Priscilla Petry", "email": "priscilla@adapta.org"},
    {"name": "Gabriel Jesus", "email": "gabrieljesus@adapta.org"},
    {"name": "Izabel Villyn", "email": "izabel@adapta.org"},
    {"name": "Raphaela Castro", "email": "raphaela.castro@adapta.org"},
    {"name": "Matheus Prado", "email": "matheus@adapta.org"},
    {"name": "Vinicius Galetti", "email": "vinicius@adapta.org"},
    {"name": "Kelvin Dutra", "email": "kelvin@adapta.org"},
    {"name": "Jamilson Scarcella", "email": "scarcella.junior@gmail.com"},
    {"name": "Bia", "email": "maria.beatriz@adapta.org"},
    {"name": "Lucas Paiva", "email": "lcspaiva87@gmail.com"},
    {"name": "Arthur da Fonte Guerra", "email": "arthur@adapta.org"}
  ]';
BEGIN
